...
public class NetworkStart {
    ...
    public void arrivalPacket(int sourceNodeIndex, int slotIndex) {
        ...
        energyQueue[slotIndex + 1] = Math.max(energyQueue[slotIndex + 1], 0);
    }

    public boolean canSuccessDecoding(int sourceNodeIndex, int slotIndex) {
        if (energyQueue[slotIndex] < 1) {
            System.out.println("energyPoorWarning:" + slotIndex);
            return false;
        }
    ...
    public NetworkStart(int timeSlot, int sourceNumber, double alpha) {
